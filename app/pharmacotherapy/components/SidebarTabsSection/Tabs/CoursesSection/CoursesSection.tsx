    ...
    return (
        <section className={styles.coursesWrapper}>
            <div className={styles.sectionHeader}>
                <h2 className={styles.mainTitle}>หลักสูตรการฝึกอบรมความรู้ความชำนาญ (Residency Training)</h2>
            </div>
            ...
            <div className={styles.topSection}>
                ...
                <div className={styles.rightSideContainer}>
                    <div className={styles.topImageContainer}>
                        <Image src="/images/courses/img1.jpg" alt="Course featured" width={480.5} height={256} className={styles.topFeaturedImage} priority />
                    </div>

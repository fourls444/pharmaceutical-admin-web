            ...
            <div className={styles.container}>
                ...
                <div className={styles.leftColumn}>
                    ...
                    <div className={styles.leftText}>
                        <h3>วิทยาลัยเภสัชบำบัด</h3>
                        <p>วิทยาลัยเภสัชบำบัด ตั้งอยู่ภายในอาคารสัญลักษณ์แห่งวิชาชีพสาธารณสุขไทย 
                            เราพร้อมอำนวยความสะดวกในด้านการสอบวุฒิบัตร การรับรองหลักสูตร 
                            และการประสานงานกับสถาบันฝึกอบรมทั่วประเทศ 
                            เพื่อขับเคลื่อนมาตรฐานการบริบาลทางเภสัชกรรมให้ก้าวไกล</p>
                    </div>
                </div>

                {/* RIGHT: Full green contact card */}
                <div className={styles.rightColumn}>
                    <h2 className={styles.rightTitle}>วิทยาลัยเภสัชบำบัด</h2>
                    ...
                    <div className={styles.contactList}>
                        ...
                        <div className={styles.contactItem}>
                            ...
                            <div>
                                <h4>ที่อยู่</h4>
                                <p>ชั้น 9 อาคารมหิตลาธิเบศร สาธารณสุข 8<br /> กระทรวงสาธารณสุข จ.นนทบุรี</p>
                            </div>
                        </div>
                        ...
                        <div className={styles.contactItem}>
                            ...
                            <div>
                                <h4>โทรศัพท์</h4>
                                <p>02-591-9992 ต่อ 7<br />02-591-9996</p>
                            </div>
                        </div>
                        ...
                        <div className={styles.contactItem}>
                            ...
                            <div>
                                <h4>เว็บไซต์หลัก</h4>
                                <p>thaibcp.pharmacycouncil.org</p>
